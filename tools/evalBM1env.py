...
class environment(gym.Env):
    ...
    def __init__(self, x,y,z ,gamma, turnspc, policy, rg_prob='rg', envpath='./environments/eval1env', rendermode='off'):
    ...
    def save(self):
        ...
        if (os.path.exists('./environments/eval1env')!=True):
            os.mkdir('./environments/eval1env')
