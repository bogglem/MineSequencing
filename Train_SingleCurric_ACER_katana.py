...
inputarray=pd.read_csv('jobarrays/single_katana_job_input.csv')
...
det=inputarray.loc[idx].deterministic
...
if __name__ == '__main__':
    ...
    callbacklist=CallbackList([TimeLimit(episodetimesteps), EvalCallback(env, log_path=savepath, n_eval_episodes=1
                                                                         ,eval_freq=10000, deterministic=det, best_model_save_path=savepath)])
