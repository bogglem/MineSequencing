...
tensorflow==1.15
sklearn
#stable-baselines (install modified version from link below) 
...
In these parameter files, you can adjust the following parameters;
...
3. Modify Train_RG_CNNA2C_drstrange.py to use the desired parameters.
You can change the parameter file via inputarray variable on line45
...
Once there is a Best_model.zip file available, it can be reloaded, implemented and qualitatively inspected.
...
2. execute CNNA2C_implement.py to see the agent acting on the environment.