...
#state_size[2]
            model = Sequential()
            model.add(Conv3D(1, kernel_size=(10, 10, state_size[2]), activation='relu', kernel_initializer='he_uniform', input_shape=state_size, padding='valid'))
            #model.add(MaxPooling3D(pool_size=(1, 1, 1)))
            #model.add(Dropout(0.1))
            #model.add(Conv3D(32, kernel_size=(3, 3, 1), activation='relu', kernel_initializer='he_uniform', padding='same'))
            #model.add(Dropout(0.1))
            #model.add(Conv3D(32, kernel_size=(2, 2, 1), activation='relu', kernel_initializer='he_uniform', padding='same'))
            #model.add(Dropout(0.1))
