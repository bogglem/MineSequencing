...
inputarray=pd.read_csv('jobarrays/annealrate_katana_job_input.csv')
...
annealrate=inputarray.loc[idx].annealrate
...
scenario=str(f'{trialv}_{inputfile_s}_t{test}_lr{LR_s}_g{gamma_s}_t{turnspc_s}_anneal{annealrate}')    
