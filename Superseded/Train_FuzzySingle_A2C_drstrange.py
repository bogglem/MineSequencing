...
if __name__ == '__main__':
    ...
    if (os.path.exists("%s/best_model.zip" % savepath)):
        ...
        model = A2C(policy, env, gamma=gamma, n_steps=episodetimesteps, learning_rate=LR,  verbose=1)#, buffer_size=500*episodetimesteps))
        ...
        model = A2C(policy, env, gamma=gamma, n_steps=episodetimesteps, learning_rate=LR,  verbose=1)#, buffer_size=500*episodetimesteps)#, tensorboard_log=scenario)
