...
import gym
from MineEnv import environment
import numpy as np
...
num_hidden = 128
input_x = layers.Input(shape=state_size, name='input_x')
conv1 = layers.Conv3D(1, kernel_size=(1, 1, 1), activation='relu', kernel_initializer='he_uniform', padding='valid')(input_x)
...
model = keras.Model(inputs=input_x, outputs=[action, critic])
